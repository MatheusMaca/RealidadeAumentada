package com.example.maca.exercicio3ar
...
class MainActivity : AppCompatActivity() {
    ...
    private fun carregarModeloPaint(): Paint {
        ...
        // define a cor
        paintRet.color = Color.MAGENTA

        // define que é um stroke
        paintRet.style = Paint.Style.STROKE

        // define a largura da linha
        paintRet.strokeWidth = 15.toFloat()
